...
returned. Response shapes match the Tinker SDK so code written against
the SDK can lift straight over by swapping the client import.
...
logger = logging.getLogger("hatchery.client")
